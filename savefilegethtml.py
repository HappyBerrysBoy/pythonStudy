...
def getMasterMergeQuery(tagn_id, prd_no, cntt_div, nt_cd, arr_city, prd_nm, tr_div, dmst_div, prd_desc, prd_desc_md):
    ...
    query += "when not matched then insert values ( b.tagn_id, b.prd_no, b.cntt_div, b.nt_cd, b.arr_city, b.prd_nm, b.tr_div, b.dmst_div, b.prd_desc, b.prd_desc_md)"
    return query
...
def getDetailMergeQuery(tagn_id, prd_no, prd_seq, prd_dtl_nm, dep_dt, arr_dt, tr_term, dep_arpt, arr_arpt, arln_id, prd_st, prd_url, prd_fee_ad, prd_fee_ch, prd_fee_bb, cmps_seat, exg_div):
    ...
    query += "when not matched then insert values ( b.tagn_id , b.prd_no , b.PRD_SEQ , b.PRD_DTL_NM , to_date(b.DEP_DT, 'yyyymmddhh24mi') , to_date(b.ARR_DT, 'yyyymmddhh24mi') , b.TR_TERM , b.DEP_ARPT , b.ARR_ARPT , b.ARLN_ID ,"
