...
def searchProduct(productcode, productName, period, targetUrl, listUrl, productDetailUrl):
...
for menu in backpackMenuList:
    ...
    for each_line in productListHtml:
        ...
        if each_line.find("sview('") > -1:
            ...
            searchProduct(productCode, productName, period, detailUrl, listUrl, productDetailUrl)
            #break
    #break
...
for regionList in freetourMenuList:
    ...
    for product_line in productHtml:
        if product_line.find('<td height="137"') > -1:
            ...
            searchProduct(productCode, productName, '', productScheduleUrl, listUrl, productDetailUrl)
            #break
    #break
...
for regionList in honeymoonMenuList:
    ...
    for region in regionHtml:
        if region.find('<li >') > -1:
            ...
            searchProduct(productCode, productName, '', productListUrl, listUrl, productDetailUrl)
